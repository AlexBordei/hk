...
class ColeteOnlineAdminOrder {
  ...
  public function get_services_list() {
    ...
    $order_data->add_packages_data($data['packages']);
  ...
  private function respond_with_fragment($order) {
  ...
  public function create_order() {
    ...
    if ($order_data_helper->has_courier_order()) {
      $this->respond_with_fragment($order);
      wp_die();
    }
